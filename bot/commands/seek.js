...
module.exports.run = (Client, msg, args) => {
    ...
    player.seek(jumpto);
    Client.functions.createEmbed(msg.channel, Client.emotes.get("check") + texts.command_seek_text + "`" + new Date(jumpto).toISOString().substr(11, 8) + "`!", texts.command_seek_title);
}