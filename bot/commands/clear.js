...
module.exports.run = (Client, msg, args) => {
    ...
    if(!guild.queue[0]) return Client.functions.createEmbed(msg.channel, Client.emotes.get("error") + texts.command_clear_queue_empty, texts.error_title);
    ...
    Client.functions.createEmbed(msg.channel, Client.emotes.get("check") + texts.command_clear_text, texts.command_clear_title);
}